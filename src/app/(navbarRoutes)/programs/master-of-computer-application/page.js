...
export const metadata = {
  title: "MCA Program | Saroj Educational Group",
  description:
    "SEG offers a 3-year MCA program with a comprehensive curriculum and practical focus. Launch your IT career with our industry-focused postgraduate program designed for future tech leaders.",
};
      ...
      <div className="bg-gradient-to-b from-blue-50 to-gray-100 py-16 px-4 sm:px-8 lg:px-16 xl:px-32 space-y-16">
        ...
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold text-blue-900 mb-6 leading-tight">
            ...
            <span className="text-blue-600">(MCA)</span>
          </h1>
          <p className="text-xl text-gray-700 mb-8">
            Advance your tech career with our industry-driven MCA program
            designed for aspiring IT professionals.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-blue-500">
            ...
            <p className="text-gray-600">
              Advanced curriculum with a focus on industry-relevant
              technologies.
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-green-500">
            ...
            <p className="text-gray-600">
              Choose from AI, Data Science, Cybersecurity, and more.
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-purple-500">
            ...
            <p className="text-gray-600">
              Real-world projects and case studies to enhance problem-solving.
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-orange-500">
            ...
            <p className="text-gray-600">
              Strong industry connections for internships and career
              opportunities.
            </p>
          </div>
        </div>

        {/* Specializations Section for MCA */}
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="p-8 md:p-10 bg-gradient-to-r from-blue-800 to-blue-600 text-white">
            <h2 className="text-3xl font-bold mb-2">Advanced Focus Areas</h2>
            <p className="text-blue-100 max-w-2xl">
              Master specialized domains in computer applications
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-8">
            <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Enterprise architecture, DevOps, Cloud-native development
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Machine learning, Big Data processing, Predictive modeling
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200">
                      Cutting-edge curriculum with industry-standard tools
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200">
                      Work on innovative projects with faculty guidance
                    </p>
                  </div>
                </div>
              </div>
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200">
                      Prepare for tech leadership and management roles
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-4">
            ...
            <div className="bg-white p-4 rounded-lg shadow text-center group hover:bg-blue-600 hover:text-white transition-all">
              ...
              <p className="font-medium">Cloud Solutions Architect</p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow text-center group hover:bg-blue-600 hover:text-white transition-all">
              <div className="bg-blue-100 group-hover:bg-blue-500 mx-auto w-16 h-16 rounded-full flex items-center justify-center mb-3">
                <svg
              ...
              <p className="font-medium">Database Architect</p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow text-center group hover:bg-blue-600 hover:text-white transition-all">
              <div className="bg-blue-100 group-hover:bg-blue-500 mx-auto w-16 h-16 rounded-full flex items-center justify-center mb-3">
                <svg
              ...
              <p className="font-medium">IT Project Manager</p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow text-center group hover:bg-blue-600 hover:text-white transition-all">
              <div className="bg-blue-100 group-hover:bg-blue-500 mx-auto w-16 h-16 rounded-full flex items-center justify-center mb-3">
                <svg
              ...
              <p className="font-medium">Cybersecurity Specialist</p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow text-center group hover:bg-blue-600 hover:text-white transition-all">
              <div className="bg-blue-100 group-hover:bg-blue-500 mx-auto w-16 h-16 rounded-full flex items-center justify-center mb-3">
                <svg
              ...
              <p className="font-medium">Research Scientist</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join our MCA program and gain the expertise to thrive in the dynamic
            tech industry.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
