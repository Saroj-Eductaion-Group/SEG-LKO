...
export const metadata = {
  title: "BCA Program | Saroj Educational Group",
  description:
    "Launch your IT career with our industry-focused undergraduate program designed for future tech leaders",
};
      ...
      <div className="bg-gradient-to-b from-blue-50 to-gray-100 py-16 px-4 sm:px-8 lg:px-16 xl:px-32 space-y-16">
        ...
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold text-blue-900 mb-6 leading-tight">
            ...
            <span className="text-blue-600">(BCA)</span>
          </h1>
          <p className="text-xl text-gray-700 mb-8">
            Launch your IT career with our industry-focused undergraduate
            program designed for future tech leaders
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-blue-500">
            ...
            <p className="text-gray-600">
              Comprehensive 6-semester curriculum with practical focus
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-green-500">
            ...
            <p className="text-gray-600">
              Cutting-edge technologies with industry relevance
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-purple-500">
            ...
            <h3 className="text-xl font-bold mb-2">Tech Labs</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-orange-500">
            ...
            <h3 className="text-xl font-bold mb-2">Internship Opportunities</h3>
            <p className="text-gray-600">
              Strong corporate partnerships for practical experience
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="p-8 md:p-10 bg-gradient-to-r from-blue-800 to-blue-600 text-white">
            <h2 className="text-3xl font-bold mb-2">Program Focus Areas</h2>
            <p className="text-blue-100 max-w-2xl">
              Develop expertise in key areas of computer applications
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-8">
            <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Full-stack development, Mobile apps, Agile methodologies
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Frontend frameworks, Backend systems, Cloud integration
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  SQL, NoSQL, Big Data fundamentals
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4 hover:bg-blue-50 p-4 rounded-lg transition-all">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  AI basics, IoT, Blockchain fundamentals
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-blue-900 rounded-2xl text-white overflow-hidden">
          <div className="p-8 md:p-10">
            <h2 className="text-3xl font-bold mb-6">Why Choose SEG for BCA?</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200">
                      Courses designed with input from IT leaders
                    </p>
                  </div>
                </div>
              </div>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200">
                      Learn from professors with industry experience
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200">
                      Dedicated cell connecting students with IT companies
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-4">
            ...
            <div className="bg-white p-4 rounded-lg shadow text-center group hover:bg-blue-600 hover:text-white transition-all">
              ...
              <p className="font-medium">System Analyst</p>
            </div>
            <div className="bg-white p-4 rounded-lg shadow text-center group hover:bg-blue-600 hover:text-white transition-all">
              <div className="bg-blue-100 group-hover:bg-blue-500 mx-auto w-16 h-16 rounded-full flex items-center justify-center mb-3">
                <svg
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join our BCA program and become part of the next generation of tech
            professionals
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
